...
/**
   * Playwright with Step Definitions
   */
PLAYWRIGHT_TYPESCRIPT_PAGE_ONLY : `
    Instructions:
    - Generate only working playwright code using typescript
    ...
    Persona:
    - Audience: Automation engineer with experience in playwright tool + typescript as programming/scripting language.
  ...
  TEST_DATA_ONLY : `
  Instruction :
  -You are an senior software tester working , your role is crucial to test the application with postive and negative test data to ensure robustness of the application 
  - As a real time software tester , Generate 10 set of dummy/fake test data for identified DOM structure from context section
...
Generate a table with export excel format with following columns
    | Field Name | Test Data (Positive) | Test Data (Negative) |
